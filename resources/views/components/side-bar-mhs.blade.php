<aside id="sidebar" class="fixed w-52 top-0 left-0 z-20 font-poppins flex flex-col flex-shrink-0 hidden h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
      ...
      <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          <ul class="pb-2 space-y-2">
            ...
            <li>
              <a href= "/registration" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                  ...
                  <span class="ml-3" hrefn="/registration" sidebar-toggle-item>Registrasi</span>
              </a>
            </li>
            <li>
              ...
              <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                <li>
                  <a href="/isi-irs" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Buat IRS</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/transcript" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Transkrip</a>
                </li>
              </ul>
            </li>
