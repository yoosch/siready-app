<aside id="sidebar" class="fixed w-52 top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
