        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a  class="flex ml-2 md:mr-24">
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SIREADY</span>
            </a>
  ...
  {{-- endnavbar --}}
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-800">
          ...
          <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
              <ul class="pb-2 space-y-2">
                ...
                <li>
                  <img src="{{ asset('images/gibran.png') }}" class="rounded-full flex mx-auto" width="100" alt="">
                </li>
                ...
                <li>
                  <a href= "/m" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                      ...
                      <span class="ml-3" hrefn="/m" sidebar-toggle-item>Registrasi</span>
                  </a>
                </li>
                <li>
                  ...
                  <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                    <li>
                      <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Buat IRS</a>
                    </li>
                    <li>
                      <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">IRS</a>
                    </li>
                    <li>
                      <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">KHS</a>
                    </li>
                    <li>
                      <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Transkrips</a>
                    </li>
                  </ul>
                </li>
      ...
      <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
        ...
        <h1 class="ml-4 mt-6 text-3xl font-semibold text-gray-900 dark:text-gray-200">IRS</h1>
        <div class = "my-2 mx-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          @foreach ($data as $item)
            <div class="p-10 my-5 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-700 flex items-center justify-between">
              <div class = "p-1">
              ...
              <svg class="arrow-icon bi bi-arrow-down cursor-pointer dark:fill-white " xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" data-semester="{{ $item->semester }}">
                ...
                if (isDown) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            let table = '<div class="additional-info dark:text-white"><table class="min-w-full mt-4 bg-white border dark:bg-gray-700 dark:text:white">';
                            table += '<thead><tr class =><th class="border py-2">Kode</th><th class="border py-2">Mata Kuliah</th><th class="border py-2">Dosen</th><th class="border py-2">Ruang</th><th class="border py-2">SKS</th></tr></thead><tbody>';
                            
                            // Assuming 'response' is an array of objects where each object represents a row
                            response.forEach(row => {
                                table += '<tr>';
                                table += `<td class="border px-4 py-2">${row.kode}</td>`;
                                table += `<td class="border px-4 py-2">${row.mata_kuliah}</td>`;
                                table += `<td class="border px-4 py-2">${row.nama_dosen}</td>`;
                                table += `<td class="border px-4 py-2">${row.ruang}</td>`;
                                table += `<td class="border px-4 py-2">${row.sks}</td>`;
                            ...
                            icon.closest('.p-10').find('.p-1').append(table);
                        },
                    ...
                    icon.closest('.p-10').find('.p-1 .additional-info').remove();
