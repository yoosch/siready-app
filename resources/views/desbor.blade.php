    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
        ...
        <div class = "text-gray-900 dark:text-gray-200">
          <h1 class="bg-gray-50 font-bold text-3xl mb-0 ml-5 mt-6 text-gray-900 rounded-lg dark:text-gray-200 dark:bg-gray-900">Hai Mulyono👋</h1>
        
          <div class="px-4 pt-3 pb-2">
            <div class="p-10 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          ...
          <div class="flex mt-5 space-x-6 px-4 pb-7 dark:bg-gray-900">
            <div class="w-[70%]  ">
                <h1 class="font-bold text-2xl mb-5">Today's Schedule</h1>
                <div class="grid grid-cols-3 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800 p-4 text-center ">
                    <div>
